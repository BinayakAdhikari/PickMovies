 ...
 */
public class TopRated extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridViewAdapter = new GridViewAdapter(TopRated.this, TopRated);
