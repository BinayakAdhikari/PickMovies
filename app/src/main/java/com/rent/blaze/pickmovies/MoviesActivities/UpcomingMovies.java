...
public class UpcomingMovies extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridViewAdapter = new GridViewAdapter(UpcomingMovies.this, upcomingMovieList);
                ...
                if (response.code() == 200) {
                    ...
                    gridViewAdapter.setClickListener(new GridViewAdapter.MovieItemClickListener() {
                        ...
                        public void onClick(Results result) {
                            startActivity(MovieDetails.getLaunchIntent(UpcomingMovies.this, result));
                        }
                    });
                }
